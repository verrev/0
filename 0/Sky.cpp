...
bool Sky::initialize()
{
	...
	mTextureSRV = DirectX11Core::createCubeTextureSRVFromFile("C:/Users/Vootele/Desktop/0/Debug/skymap.dds");
	...
	ID3DBlob *vsByteCode = DirectX11Core::readShaderFromFile("C:/Users/Vootele/Desktop/0/Debug/SKY_VS.cso");
	...
	ID3DBlob *psByteCode = DirectX11Core::readShaderFromFile("C:/Users/Vootele/Desktop/0/Debug/SKY_PS.cso");
...
void Sky::draw(const XMVECTOR &camPos)
{
	...
	mCBData.world = XMMatrixTranspose(XMMatrixTranslation(XMVectorGetX(camPos), XMVectorGetY(camPos), XMVectorGetZ(camPos)));
